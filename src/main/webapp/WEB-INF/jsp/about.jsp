		...
		<main class="about-page">
			...
			<section class="about-profile">
				...
				<div class="about-profile__content">
					...
					<h1 class="about-profile__title">自己紹介</h1>
			...
			<section class="about-hobby">
				...
				<h2 class="about-hobby__main-title">趣味</h2>
				...
				<div class="about-hobby__item">
					...
					<div class="about-hobby__image-area">
						...
						<img src="${pageContext.request.contextPath}/image/bikeMy.png" alt="原付旅の写真"
							class="about-hobby__image">

					</div>

					<div class="about-hobby__content">

						<h3 class="about-hobby__title">原付旅</h3>
				...
				<!-- ドラム -->
				<div class="about-hobby__item about-hobby__item--reverse">
					...
					<div class="about-hobby__content">
						...
						<h3 class="about-hobby__title">ドラム</h3>
						...
						<div class="about-hobby__youtube">
						    <iframe
						        width="560"
						        height="315"
						        src="https://www.youtube.com/embed/TCkYWIbBMKA"
						        title="ドラム演奏"
						        frameborder="0"
